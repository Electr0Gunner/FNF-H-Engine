...
class FlxSoundTray extends Sprite
{
	...
	public function new()
	{
		...
		text2 = new TextField();
		text2.width = tmp.width;
		text2.height = tmp.height;
		...
		var curVolTxt:TextFormat = new TextFormat("VCR OSD Mono", 10, 0xffffff);
		curVolTxt.align = TextFormatAlign.CENTER;
		text2.defaultTextFormat = curVolTxt;
		text2.text = _curVol;
		text2.y = 6;
		addChild(text2);
	...
	{
		_curVol = Std.string(FlxG.sound.volume); //just for the text
		text2.text = _curVol;
